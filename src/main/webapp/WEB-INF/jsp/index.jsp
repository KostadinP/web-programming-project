...
<body ng-app="avAngularStartupApp">
	...
	<div class="container">
		...
		<div class="footer">
			<p>
				<span class="glyphicon glyphicon-heart"></span>from the Web
				programming team
			</p>
		</div>
	</div>
	...
	<script src="scripts/controllers/professor.js"></script>
	...
	<script src="scripts/services/professor.js"></script>
